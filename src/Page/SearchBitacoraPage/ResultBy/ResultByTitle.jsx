                      ...
                      bitacora.MUESTREOS.map((muestreo, index) => (
                        <Paper key={index} elevation={3} className="muestreo-card">
                          ...
                          <Typography variant="body2" paragraph>
                            <strong>Descripción del Hábitat:</strong> {muestreo.DESCRIPCION_HABITAD}
                          </Typography>
                          <Typography variant="body2" paragraph>
                            <strong>Observación:</strong> {muestreo.OBSERVACION}
                          </Typography>
                          <Typography variant="body2" paragraph>
                            <strong>Condición Climática:</strong> {muestreo.CONDICION_CLIMATICA}
                          </Typography>
                          <Typography variant="body2" paragraph>
                          ...
                          {muestreo.especies?.length > 0 ? (
                                ...
                                <Grid item xs={12} sm={6} md={4} key={i}>
                                  <Paper className="especie-card" elevation={2}>
                                    ...
                                    {especie.FOTOGRAFIAS?.length > 0 ? (
                                      ...
                                      <Typography variant="body2">No hay fotos disponibles.</Typography>
                                    )}
                                  </Paper>
                                </Grid>
                              ))}
                            ...
                            <Typography variant="body2">No hay especies disponibles.</Typography>
                          )}
                        </Paper>
                      ))
                    ) : (
                      <Typography variant="body2">No hay muestreos disponibles.</Typography>
                    )}
                  </CardContent>
                </Card>
              ))
